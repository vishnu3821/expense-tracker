    ...
    <div className="flex h-screen w-full items-center justify-center bg-slate-50 px-4 font-sans">
      <div className="w-full max-w-md card p-8 mx-auto">
        <div className="text-center mb-8 flex flex-col items-center relative overflow-hidden">
          <img src="/website_logo.png" alt="Expense Monitor" className="h-32 w-auto object-contain -my-8" />
          ...
          <>
            ...
            <div className="mt-6">
              <button
                ...
                disabled={loading}
                className="w-full inline-flex items-center justify-center gap-3 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 disabled:opacity-50 transition-colors"
              >
