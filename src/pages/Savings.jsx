        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300 touch-none">
          ...
          >
                ...
                <div className="space-y-3">
                  {accountActivity.map((txn) => {
                    ...
                    <div
                      ...
                      className={`p-5 bg-slate-50 dark:bg-slate-800/50 rounded-3xl border border-slate-100 dark:border-slate-800 transition-all duration-500 group cursor-pointer active:scale-[0.98] ${
                        txn.category === 'Food & Dining' ? 'hover:shadow-[0_0_30px_-10px_rgba(249,115,22,0.3)] hover:border-orange-500/30' :
                        txn.category === 'Shopping' ? 'hover:shadow-[0_0_30px_-10px_rgba(168,85,247,0.3)] hover:border-purple-500/30' :
                        txn.category === 'Bills & Utilities' ? 'hover:shadow-[0_0_30px_-10px_rgba(234,179,8,0.3)] hover:border-amber-500/30' :
                        txn.category === 'Transport' ? 'hover:shadow-[0_0_30px_-10px_rgba(59,130,246,0.3)] hover:border-blue-500/30' :
                        'hover:shadow-[0_0_30px_-10px_rgba(16,185,129,0.3)] hover:border-emerald-500/30'
                      }`}
                    >
            ...
            <div className="p-8 pt-0">
              <button 
                onClick={() => setSelectedAccountId(null)}
                className="w-full h-16 bg-white/5 hover:bg-white/10 text-emerald-400 rounded-2xl font-black uppercase tracking-[0.3em] text-xs border border-emerald-500/30 hover:border-emerald-500 transition-all shadow-[0_0_20px_rgba(16,185,129,0.1)] hover:shadow-[0_0_30px_rgba(16,185,129,0.2)]"
              >
                Close Activity Feed
              </button>
            </div>
